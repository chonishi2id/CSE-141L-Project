...
Func2_start:
	...
	ldi r0, #4  		// Prepare to load 64 = 1000000
	ls  r0, #4
...
Func2_loop:
	ldi r3, #7      // Prepare to load address 224 = 11100000
	ls  r3, #5
...
p8_exp:
	...
	neq r0, r1
	// (b11^b10^b9)^b8  
	add r3, r2			// Load from dm209
	ldr r1, r3
	neq r0, r1
	// ^b11:b8^b7  
	add r3, r2			// Load from dm208
	ldr r1, r3
	neq r0, r1 
	// ^b11:b7^b6 
	add r3, r2			// Load from dm207
	ldr r1, r3
	neq r0, r1
	// ^b11:b6^b5 
	add r3, r2			// Load from dm206
	ldr r1, r3
	neq r0, r1

p8_comparison:
	addi r3, #7 		// Prepare to store into dm213 by inc 7 from 206
...
p4_exp:
	...
	neq r0, r1
	// b11^b10^b9        
	addi r3, r2   	// dec to load dm210
	ldr r1, r3
	neq r0, r1
	// (b11^b10^b9)^b8  
	addi r3, r2			// dec to load dm209
	ldr r1, r3
	neq r0, r1
	// ^b11:b8^b4
	ldi r3, #6			// Prepare to load from dm204 = 11001100
	ls	r3, #3
	addi r3, #3
	ls	r3, #2
	ldr r1, r3
	neq r0, r1
	// ^b11:b8^b4^b3
	addi r3, r2			// dec to load dm203
	ldr r1, r3
	neq r0, r1
	// ^b11:b8^b4^b3^b2
	addi r3, r2			// dec to load dm202
	ldr r1, r3
	neq r0, r1 

p4_comparison:
	addi r3, r2 		// dec to load dm201 a few instructions later
...
p16_loop:
	// p16 = ^b11:1, p8, p4, p2, p1 or ^p8, b4:b1, p8, p4, p2, p1
	// p8^b4
	ldi r2, #6			// Prep dm205 = 11001101
	ls	r2, #3
	addi r2, #3
	ls	r2, #2
	addi r2, #1
	...
	//p8^b4^b3
	add r2, r3			// Prep dm203 by dec 1
	ldr r1, r2
	neq r0, r1

	//p8^(b4:b2)
	add r2, r3			// Prep dm202 by dec 1
	ldr r1, r2
	neq r0, r1

	//p8^(b4:b2)^p4
	add r2, r3			// Prep dm201 by dec 1
	ldr r1, r2
	neq r0, r1
	
	//p8^(b4:b1)^p4
	add r2, r3			// Prep dm 200 by dec 1
	ldr r1, r2
	neq r0, r1

	//p8^(b4:b1)^p4^p2
	add r2, r3			// Prep dm199 by dec 1
	ldr r1, r2
	neq r0, r1

	//p8^(b4:b1)^p4^p2^p1
	add r2, r3			// Prep dm198 by dec 1
	ldr r1, r2
	neq r0, r1

	//p8^(b4:b1)^p4^p2^p1^p8
	addi r2, #7			// Prep 205 by inc 7 from 198
	ldr r1, r2
	neq r0, r1

p16_comparison:
	ldi r2, #6			// Prep to load dm217 = 11011001
	ls	r2, #3
	addi r2, #6
	ls	r2, #2
	addi r2, #1
...
output:
  ...
  // load output address for LSW
	ldi r2, #7			// prep to load dm226=11100010
	ls	r2, #5
	addi r2, #2
  ldr r1, r2
